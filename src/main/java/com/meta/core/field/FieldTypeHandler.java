...
public interface FieldTypeHandler<T> {
     ...
     * @param fieldBean
     */
    String getTypeId(FieldBean fieldBean);
     ...
     * @param fieldBean
     */
    Class<?> getStorageType(FieldBean fieldBean);
...
//    T parseFromString(String input) throws FieldDataException;
    T parseFromString(String input, FieldBean fieldBean);
     ...
     * @throws FieldDataException 如果解析失败.
     */
    default T parseFromUntyped(Object rawValue, FieldBean fieldBean, ConversionContext context) throws FieldDataException{
        return FieldType.valueOf(getTypeId(fieldBean)).getDataType().convert(rawValue);
    }
     ...
     * @return 用于显示的字符串.
     */
    String formatForDisplay(Object value, FieldBean fieldBean, ConversionContext context);
